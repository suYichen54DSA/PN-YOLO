...
def create_dataloader(
    ...
    """Creates and returns a DataLoader instance for loading only images without labels."""
    if rect and shuffle:
    ...
    loader = DataLoader  # 不需要 InfiniteDataLoader，因为不需要标签
    ...
    return loader(
        ...
        collate_fn=None,  # 不需要自定义 collate_fn
...
class LoadImages:
    ...
    def __getitem__(self, index):
        ...
        # 如果有 transforms 则进行变换，否则进行默认预处理
        if self.transforms:
